...
export default function HeroSection() {
  return (
    <section id="hero" className="relative min-h-screen bg-cream pt-16 pb-16 md:pt-28 md:pb-20">
      <Container>
        <div className="mx-auto max-w-[900px]">
          <p className="mb-4 text-xs font-medium uppercase tracking-[0.15em] text-primary">
          ...
          <p className="mt-4 max-w-[580px] text-lg leading-relaxed text-muted md:text-xl">
        ...
        {/* Product stage — brought up closer to viewport */}
        <div className="relative mt-8 -mx-6 md:-mx-10 lg:-mx-16">
          <ConversationEngine />
        </div>
      </Container>
    </section>
